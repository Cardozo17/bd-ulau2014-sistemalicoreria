...
public class VentanaInventario extends JFrame implements ActionListener {
	...
	private void initGUI() {
		...
		JTable tabla=new JTable();
		   String[] columnas = {"id", "Nombre", "Proveedor", "Cantidad","Precio Unitario"};//columnas de la tabla
...
/********************** Configurando la interfaz**************************************/	
		...
		//Agregando a la interfase la etiqueta de Cantidad y El campo de texto Cantidad
		config.gridx=3;config.gridy=9;
		config.gridheight=1;config.gridwidth=1;
		config.weightx=0;
		config.fill=GridBagConstraints.BOTH;
		...
		config.gridx=3;config.gridy=10;
		config.gridheight=1;config.gridwidth=1;
	    config.weighty=0;
		config.fill=GridBagConstraints.HORIZONTAL;
		...
		config.gridx=3;config.gridy=11;
		config.gridheight=1;config.gridwidth=1;
		config.weighty=0;
		config.fill=GridBagConstraints.HORIZONTAL;
		...
		config.gridx=4;	config.gridy=11;
		config.gridheight=1;config.gridwidth=1;
		config.weighty=0;
		config.fill=GridBagConstraints.HORIZONTAL;
	...
	//acciones al presionar los botones
	   ...
	   { 
	    ...
	    private void botonActualizarActionPerformed(ActionEvent evt,ProductoVO producto) {
				// TODO Auto-generated method stub
			   ProductoDAO productoBD=new ProductoDAO();
			   productoBD.actualizarProducto(producto);
		} 
	  
	   private void botonEliminarActionPerformed(ActionEvent evt,ProductoVO producto) 
	   { 
		   ProductoDAO productoBD=new ProductoDAO();
